...
export const OFFICIAL_SOCIAL_LINKS = [
  {
    id: 'youtube',
    name: 'YouTube',
    handle: '@AvyuktUtthanSanstha',
    url: 'https://www.youtube.com/@AvyuktUtthanSanstha',
    brandColor: '#ff0000',
  ...
  },
  {
    id: 'instagram',
    name: 'Instagram',
    handle: '@avyukt.utthan.sanstha',
    url: 'https://www.instagram.com/avyukt.utthan.sanstha/',
    brandColor: '#e1306c',
  ...
  },
  {
    ...
    name: 'Facebook',
    handle: 'Avyukt Utthan Sanstha',
    url: 'https://www.facebook.com/profile.php?id=61591721361540&sk=reels_tab',
    brandColor: '#1877f2',
  ...
  },
  {
    ...
    name: 'LinkedIn',
    handle: 'avyukt-utthan-sanstha',
    url: 'https://www.linkedin.com/in/avyukt-utthan-sanstha/',
    brandColor: '#0a66c2',
